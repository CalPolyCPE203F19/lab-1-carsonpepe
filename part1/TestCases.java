...
public class TestCases
{
   ...
   {
      assertEquals(19.2, SimpleIf.max(5.2, 19.2), DELTA);
      assertEquals(4.2, SimpleIf.max(4.2, 4.1), DELTA);
   }
   ...
   {
      assertEquals(54, SimpleLoop.sum(2, 10));
   }
   ...
   {
      assertArrayEquals(new int[] {36, 144, 4, 81, 16},
                        SimpleArray.squareAll(new int[] {6, 12, 2, 9, 4}));
   }
   ...
   {
      List<Integer> input = 
         new LinkedList<Integer>(Arrays.asList(new Integer[] {5, 7, 10}));
      List<Integer> expected = 
         new ArrayList<Integer>(Arrays.asList(new Integer[] {25, 49, 100}));
   ...
   {
      List<String> expected = Arrays.asList("Carson", "John");
      Map<String, List<Course>> courseListsByStudent = new HashMap<>();

      courseListsByStudent.put("Carson",
         Arrays.asList(
            new Course("CPE 111", 4),
            new Course("CPE 112", 4),
            new Course("EE 306", 4),
            new Course("Shitty GE", 2)));
      courseListsByStudent.put("Ron",
         Arrays.asList(
            new Course("AGB 444", 4),
            new Course("PSY 100", 4),
            new Course("GE SZN", 4)));
      courseListsByStudent.put("John",
         Arrays.asList(
            new Course("BLAH", 4),
            new Course("IM BORED", 4),
            new Course("SUPERUNIT", 10)));
